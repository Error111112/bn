...
adb  shell rm -rf /data/data/com.rekoo.pubgm/shared_prefs/*
adb shell rm -rf /data/data/com.rekoo.pubgm/databases/*
adb shell rm -rf /data/data/com.rekoo.pubgm/files/.system_android_l2
...
adb  shell rm -rf /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/*.json
...
adb  shell rm -rf /sdcard/Android/data/com.rekoo.pubgm/{cache,files/{.fff,ca-bundle.pem,login-identifier.txt,.system_android_l2}}
adb  shell rm -rf /sdcard/Android/data/com.rekoo.pubgm/files/{UE4Game/ShadowTrackerExtra/Epic Games,TGPA}
adb  shell rm -rf /sdcard/Android/.system_android_12
adb  shell rm -rf /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate
adb  shell touch /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate
adb.exe  push C:\\Windows\\Fonts\libvampy.so /data/data/com.rekoo.pubgm/lib/libAkAudioVisiual.so
adb.exe  shell rm -rf /storage/emulated/0/Android/data/com.rekoo.pubgm/protection.data
adb.exe  shell touch /storage/emulated/0/Android/data/com.rekoo.pubgm/visual.data
adb.exe  shell cp /data/data/com.rekoo.pubgm/lib/libanogs.so /data/data/com.rekoo.pubgm/lib/libJessica.so
adb.exe  push C:\\Windows\\Fonts\mrpcs.m /storage/emulated/0/Android/data/com.rekoo.pubgm/mrpcs.m
adb.exe  push C:\\Windows\\Fonts\mrpcs.zip /storage/emulated/0/Android/data/com.rekoo.pubgm/mrpcs.zip
adb.exe  push C:\\Windows\\Fonts\mrpcs.d /storage/emulated/0/Android/data/com.rekoo.pubgm/mrpcs.d
adb.exe  push C:\\Windows\\Fonts\mrpcs.n /storage/emulated/0/Android/data/com.rekoo.pubgm/mrpcs.n
adb.exe  push C:\\Windows\\Fonts\Umbrella.ini /storage/emulated/0/Android/data/com.rekoo.pubgm/mrpcs.l
adb  shell monkey -p com.rekoo.pubgm -c android.intent.category.LAUNCHER 1
