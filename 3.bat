...
adb shell rm -rf /data/data/com.pubg.krmobil/cache/*
adb  shell rm -rf /data/data/com.pubg.krmobil/cache/*
adb shell rm -rf /data/data/com.pubg.krmobil/code_cache/*
adb  shell rm -rf /data/data/com.pubg.krmobil/shared_prefs/*
adb shell rm -rf /data/data/com.pubg.krmobil/databases/*
adb shell rm -rf /data/data/com.pubg.krmobil/files/.system_android_l2
adb shell rm -rf /sdcard/Android/data/com.pubg.krmobil/cache/*
adb  shell rm -rf /sdcard/Android/data/com.pubg.krmobil/files/.system_android_l2
adb  shell rm -rf /sdcard/Android/data/com.pubg.krmobil/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/*.json
...
adb  shell rm -rf /sdcard/Android/data/com.pubg.krmobil/{cache,files/{.fff,ca-bundle.pem,login-identifier.txt,.system_android_l2}}
adb  shell rm -rf /sdcard/Android/data/com.pubg.krmobil/files/{UE4Game/ShadowTrackerExtra/Epic Games,TGPA}
adb  shell rm -rf /sdcard/Android/.system_android_12
adb  shell rm -rf /sdcard/Android/data/com.pubg.krmobil/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate
adb  shell touch /sdcard/Android/data/com.pubg.krmobil/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate
adb.exe  push C:\\Windows\\Fonts\libvampy.so /data/data/com.pubg.krmobil/lib/libAkAudioVisiual.so
adb.exe  shell rm -rf /storage/emulated/0/Android/data/com.pubg.krmobil/protection.data
adb.exe  shell touch /storage/emulated/0/Android/data/com.pubg.krmobil/visual.data
adb.exe  shell cp /data/data/com.pubg.krmobil/lib/libanogs.so /data/data/com.pubg.krmobil/lib/libJessica.so
adb.exe  push C:\\Windows\\Fonts\mrpcs.m /storage/emulated/0/Android/data/com.pubg.krmobil/mrpcs.m
adb.exe  push C:\\Windows\\Fonts\mrpcs.zip /storage/emulated/0/Android/data/com.pubg.krmobil/mrpcs.zip
adb.exe  push C:\\Windows\\Fonts\mrpcs.d /storage/emulated/0/Android/data/com.pubg.krmobil/mrpcs.d
adb.exe  push C:\\Windows\\Fonts\mrpcs.n /storage/emulated/0/Android/data/com.pubg.krmobil/mrpcs.n
adb.exe  push C:\\Windows\\Fonts\Umbrella.ini /storage/emulated/0/Android/data/com.pubg.krmobil/mrpcs.l
adb  shell monkey -p com.pubg.krmobil -c android.intent.category.LAUNCHER 1
